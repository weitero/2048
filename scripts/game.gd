...
const THEMES := {
	...
	"Colorblind": {
		"bg":          Color("#2b2d42"),
		"title":       Color("#edf2f4"),
		"subtitle":    Color("#8d99ae"),
		"hint":        Color("#8d99ae"),
		"score_bg":    Color("#1a1b26"),
		"score_lbl":   Color("#8d99ae"),
		"score_val":   Color("#edf2f4"),
		"overlay_dim": Color(0.1, 0.1, 0.1, 0.8),
		"overlay_box": Color("#2b2d42"),
		"btn_normal":  Color("#1a1b26"),
		"btn_hover":   Color("#8d99ae"),
		"btn_pressed": Color("#0d0e15"),
		"btn_text":    Color("#edf2f4"),
		"overlay_txt": Color("#edf2f4"),
		"board_bg":    Color("#1a1b26"),
		"cell_slot":   Color("#2b2d42"),
		"toggle_text": Color("#edf2f4"),
		"tiles": {
			2:      Color("#03045e"),
			4:      Color("#023e8a"),
			8:      Color("#0077b6"),
		...
		"dark_text":  Color("#ffffff"),
		"light_text": Color("#000000"),
		"unknown_bg": Color("#2b2d42"),
		"light_text_threshold": 128,
	}
}
